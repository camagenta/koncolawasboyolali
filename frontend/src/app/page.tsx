      ...
      <main className="flex-1">
        <section className="max-w-6xl mx-auto px-4 pt-12 md:pt-20 pb-6 md:pb-10 text-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-xl px-8 py-3 text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-lg"
          >
      ...
      <footer className="border-t border-gray-100 py-8">
        <div className="max-w-6xl mx-auto px-4 text-center text-sm text-gray-400">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <a
              href="https://web.facebook.com/groups/63868647864"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-sm"
            >
